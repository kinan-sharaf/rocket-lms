                    ...
                    child: Column(
                      children: [
                        ...
                        if(userProvdider.cartData?.totalCashbackAmount != null)...{
                          helperBox(AppAssets.walletSvg, appText.getCashback, '${appText.finalizeYourOrderAndGet} ${CurrencyUtils.calculator(userProvdider.cartData?.totalCashbackAmount ?? 0, fractionDigits: 1)} ${appText.cashback}'),
