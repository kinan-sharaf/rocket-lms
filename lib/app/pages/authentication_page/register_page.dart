                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            // student
                            AuthWidget.accountTypeWidget(appText.student, accountType, 'user', (){
                              setState(() {
                                accountType = 'user';
                              });
                              getAccountTypeFileds();
                            ...
                            // instructor
                            AuthWidget.accountTypeWidget(appText.instrcutor, accountType, 'instructor', (){
                              setState(() {
                            ...
                            // organization
                            AuthWidget.accountTypeWidget(appText.organization, accountType, 'organization', (){
                              setState(() {
                    ...
                    : Column(
                      ...
                      Center(
                        child: GestureDetector(
                          onTap: (){
                            nextRoute(WebViewPage.pageName, arguments: ['https://app.rocket-soft.org/pages/app-terms', appText.webinar, false, LoadRequestMethod.get]);
                          },
                          behavior: HitTestBehavior.opaque,
                          child: Text(
