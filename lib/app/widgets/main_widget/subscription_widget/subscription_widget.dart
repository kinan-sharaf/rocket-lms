                                  ...
                                  child: Center(
                                    child: button(
                                      onTap: () async {
                                        ...
                                        //   arguments: [
                                        //     // 'https://app.rocket-soft.org/panel/financial/subscribes/${data?.subscribes?[index].id}',
                                        //     'https://app.rocket-soft.org/panel/financial/subscribes/',
                                        //     appText.subscription,
                                        //     true, // send token
                                        //     LoadRequestMethod.get
                                        //   ]
                                        // );
                                        // var token = await AppData.getAccessToken();
                                        // var header = {
                                ...
                                Padding(
                                  ...
                                  child: button(
                                    onTap: () async {
                                      ...
                                      //   WebViewPage.pageName,
                                      //   arguments: [
                                      //     'https://app.rocket-soft.org/panel/financial/registration-packages',
                                      //     appText.saaSPackages,
                                      //     true, // send token
                                      //     LoadRequestMethod.get
                                      //   ]
                                      // );
